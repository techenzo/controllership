...
<div class="container">
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        ...
        <div class="col-xs-12 col-md-6"><a href="/" class="btn btn-danger btn-block btn-lg" tabindex="1">Back</a></div> 
    <div class="col-xs-12 col-md-6"><a href="/crrs/{{$vendor->id}}"><input type="submit" value="Routing Slip" class="btn btn-primary btn-block btn-lg" tabindex="2"></a></div> 
    </div>
