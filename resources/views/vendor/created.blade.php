...
@section('content')
    ...
    <div class="row">
        {!! Form::open(['action' => 'VendorsController@store', 'method' => 'POST', 'enctype' =>'multipart/form-data' id="js-upload-form"]) !!}
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <form role="form">
                        <h2>Vendor Contact Info</h2>
                        <hr class="colorgraph">
                        <div class="form-group">
                                <input type="text" name="vendor_name" id="js-upload-form"class="form-control input-lg" placeholder="Vendor Company Name" tabindex="1">
                        </div>
                                                ...
                                                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                        ...
                                                        <div class="modal-body form-group">
                                                                ...
                                                                <div class="form-group">
                                                                        ...
                                                                        <form action="{{ action('VendorsController@uploadSubmit') }}" method="post" enctype="multipart/form-data" id="js-upload-form">
                                                                                {{ csrf_field() }}
