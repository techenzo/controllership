...
<body>
    <div class ="container">
        <table width = "100%">
            <tr>
                <td><img src="/uploads/logo/ingram-blue.png" style="height:50%;display:inline-block;"></td>
    ...
    <br>
    <center>
    <a type="button" class="btn btn-primary" href="{{ route('generate-pdf',['download'=>'pdf', 'vendor' => $vendor->id]) }}">Download PDF</a>
    </center>
    </br>
