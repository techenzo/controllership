        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <form role="form">
                        ...
                        <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                        <input type="text" name="last_name" id="last_name" class="form-control input-lg" placeholder="Last Name" tabindex="5">
                                        </div>
                                </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                        <input type="text" name="weburl" id="weburl" class="form-control input-lg" placeholder="Website Url" tabindex="8">
                        ...
                        <div class="form-group contract">
                                        <select name="contract" id ="contract"data-filter="make" class="filter-make filter form-control input-lg" tabindex="2">
                        ...
                        <div class="row" id="filter">
                                <form>
                                        ...
                                        <div id ="cat" class="form-group col-sm-6 col-xs-6 cat">
                                                <select name="category" id ="category" data-filter="model" class="filter-model filter form-control input-lg" tabindex="3">
                                                        <option value="0" disabled selected>Contract Type</option>
                                        ...
                                        <div class="form-group col-sm-6 col-xs-6 hresources" >
                                                <select name="department" id ="department"data-filter="type" class="filter-type filter form-control input-lg">
                        ...
                        <div class="row">
                                ...
                                <input name="effectivedate" type='text' class="form-control" id='effectdate' onclick="$('#effectdate').datepicker(changeMonth: true,changeYear: true,minDate: 0);$('#effectdate').datepicker('show');"/>
                                </div>
                                <div class='col-sm-6'>
                                <label for="comment">Expiration Date</label>
                                <input name="expirationdate" type='text' class="form-control" id='expiredate' onclick="$('#expiredate').datepicker();$('#expiredate').datepicker('show');"/>
                                </div>
                        </div>
                        <br>
                        ...
                        <div class="form-group">      
                                ...
                                <textarea class="form-control" rows="5" id="comment">{{ $state->terms}}
                                @endforeach
                                </textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                                <div class="col-xs-4 col-sm-3 col-md-3">
                                        <span class="button-checkbox">
                                                ...
                                                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter">Upload Files</button>
